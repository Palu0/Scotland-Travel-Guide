...
let locations: [Location] = [
    ...
    Location(name: "Edinburgh Castle", latitude: 55.9486, longitude: -3.1999, color: .blue, description: "A historic fortress dominating the skyline of Edinburgh from Castle Rock. It has served as a royal residence, military stronghold, and symbol of Scottish heritage, housing the Crown Jewels and the Stone of Destiny."),
    Location(name: "Arthur's Seat", latitude: 55.9445, longitude: -3.1618, color: .blue, description: "An ancient volcano and the highest point in Holyrood Park, offering panoramic views over Edinburgh. Popular for hiking, it’s also tied to myths and legends, including connections to King Arthur."),
    //[NO INFORMATION FOUND]Location(name: "Kelvingrove Art Gallery and Museum", latitude: 55.8680, longitude: -4.2906, color: .blue),
    Location(name: "The Real Mary King's Close", latitude: 55.9508, longitude: -3.1901, color: .blue, description: "A historic underground street beneath Edinburgh’s Royal Mile. Once a bustling neighborhood, it was sealed off during the plague years. Now a popular tour site, it offers a glimpse into 17th-century life and eerie urban legends."),
    Location(name: "Celtic Park", latitude: 55.8497, longitude: -4.2055, color: .blue, description: "The home stadium of Celtic Football Club in Glasgow, one of Scotland’s most iconic football grounds. Known for its passionate fans and electric match-day atmosphere, it’s a central site in Scottish football history."),
    ...
    Location(name: "Fairy Pools", latitude: 57.2500, longitude: -6.2720, color: .blue, description: "A series of crystal-clear waterfalls and pools at the foot of the Black Cuillin mountains on the Isle of Skye. Known for their vivid blue waters, they’re a popular spot for hiking, photography, and wild swimming."),
    Location(name: "Scott Monument", latitude: 55.9531, longitude: -3.1937, color: .blue, description: "A towering Gothic structure on Edinburgh’s Princes Street, built to honour Scottish author Sir Walter Scott. Visitors can climb its narrow stairs for panoramic views of the city and learn about Scott’s literary legacy."),
    Location(name: "Greyfriars Bobby", latitude: 55.9471, longitude: -3.1910, color: .blue, description: "The loyal Skye Terrier who famously guarded his owner’s grave for 14 years at Greyfriars Cemetery in Edinburgh. His story of devotion is commemorated by a statue near the cemetery, making him a beloved symbol of loyalty."),
    Location(name: "Ibrox Stadium", latitude: 55.8520, longitude: -4.3090, color: .blue, description: "The iconic home of Rangers Football Club in Glasgow. Known for its passionate fanbase and rich football history, Ibrox is one of Scotland's most famous and historic football grounds."),
    Location(name: "Forth Bridge", latitude: 56.0000, longitude: -3.4000, color: .blue, description: "A UNESCO World Heritage Site and an engineering marvel, this iconic railway bridge spans the Firth of Forth. Completed in 1890, its distinctive red color and steel structure make it one of Scotland’s most recognized landmarks."),
    Location(name: "George Square", latitude: 55.8611, longitude: -4.2500, color: .blue, description: "The central hub of Glasgow, surrounded by historic buildings and statues. It’s a popular spot for events, festivals, and gatherings, offering a mix of culture and city life."),
